...
def index(request):
    ...
    context = {
        ...
        'product_count': product.count(),
        'order_count': order.count(),
        'customer_count': staff_users.count(),
    }
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'There was an error creating the order.')
...
def product_edit(request, pk):
    ...
    return render(request, 'dashboard/products_edit.html', {'form': form})
...
def product_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('dashboard-products')
    return render(request, 'dashboard/products_delete.html', {'item': item})
